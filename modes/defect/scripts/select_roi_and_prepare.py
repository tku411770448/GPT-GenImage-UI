...
def main() -> None:
    ...
    print("Next run:")
    print(f"  python scripts\\batch_from_folders.py --class-name {(args.class_name or args.defect_type)} --workflow reference-guided-edit --size 1280x1280 --quality high --num-outputs 1")
